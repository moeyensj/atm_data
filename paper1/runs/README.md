...
The result's databases were originally generated by `atm.multiFit` and then post-processed (see: [notebooks/analysis/post_processing.ipynb]()). 
...
|---|---|---|---|---|---|
| [atm_results_run0.db](https://github.com/moeyensj/atm/tree/master/data/runs/atm_results_run0.db) | $logD$, $logT1$, $\epsilon$ | Flat $\epsilon$ | Kirchoff $\left( p = \frac{1 - \epsilon}{q(G)} \right)$ | W1,W2,W3,W4 | - | 
| [atm_results_run1.db](https://github.com/moeyensj/atm/tree/master/data/runs/atm_results_run1.db) | $logD$, $logT1$, $\epsilon_{W1W2}$ |  $\epsilon_{W3W4}$ = 0.9 | Kirchoff $\left( p = \frac{1 - \epsilon}{q(G)} \right)$ | W1,W2,W3,W4 | Model 1 |
| [atm_results_run2a.db](https://github.com/moeyensj/atm/tree/master/data/runs/atm_results_run2a.db) | $logD$, $logT1$, $\epsilon_{W1W2}$ |  $\epsilon_{W3}, \epsilon_{W4}$ = (0.70, 0.86)  | Kirchoff $\left( p = \frac{1 - \epsilon}{q(G)} \right)$ |  W1,W2,W3,W4 | Model 2 |
| [atm_results_run2b.db](https://github.com/moeyensj/atm/tree/master/data/runs/atm_results_run2b.db) |  $logD$, $logT1$, $\epsilon_{W1}$, $\epsilon_{W2}$ |  $\epsilon_{W3}, \epsilon_{W4}$ = (0.70, 0.86)  | Kirchoff $\left( p = \frac{1 - \epsilon}{q(G)} \right)$ | W1,W2,W3,W4 | - |
| [atm_results_run3a.db](https://github.com/moeyensj/atm/tree/master/data/runs/atm_results_run3a.db) | $logD$, $logT1$, $\epsilon_{W1W2}$ |  $\epsilon_{W3}, \epsilon_{W4}$ = (0.76, 0.93)  | Kirchoff $\left( p = \frac{1 - \epsilon}{q(G)} \right)$ | W1,W2,W3,W4 | Model 3 |
| [atm_results_run3b.db](https://github.com/moeyensj/atm/tree/master/data/runs/atm_results_run3b.db) | $logD$, $logT1$, $\epsilon_{W1}$, $\epsilon_{W2}$ |  $\epsilon_{W3}, \epsilon_{W4}$ = (0.76, 0.93)  | Kirchoff $\left( p = \frac{1 - \epsilon}{q(G)} \right)$ | W1,W2,W3,W4 | - |
| [atm_results_run4a.db](https://github.com/moeyensj/atm/tree/master/data/runs/atm_results_run4a.db) | $logD$, $logT1$, $\epsilon_{W1W2}$ |  $\epsilon_{W3}, \epsilon_{W4}$ = (0.80, 0.98)  | Kirchoff $\left( p = \frac{1 - \epsilon}{q(G)} \right)$ | W1,W2,W3,W4 | Model 4 |
| [atm_results_run4b.db](https://github.com/moeyensj/atm/tree/master/data/runs/atm_results_run4b.db) | $logD$, $logT1$, $\epsilon_{W1}$, $\epsilon_{W2}$ |  $\epsilon_{W3}, \epsilon_{W4}$ = (0.80, 0.98)  | Kirchoff $\left( p = \frac{1 - \epsilon}{q(G)} \right)$ | W1,W2,W3,W4 | Model 5 |
| [atm_results_run5a.db](https://github.com/moeyensj/atm/tree/master/data/runs/atm_results_run5a.db ) | $logD$, $logT1$, $p_{W1W2}$ |  $\epsilon$ = 0.9  | $p_{W3W4}$ = 0.0 | W1,W2,W3,W4 | - |
| [atm_results_run5b.db](https://github.com/moeyensj/atm/tree/master/data/runs/atm_results_run5b.db) | $logD$, $logT1$, $p_{W1W2}$ |  $\epsilon$ = 0.9  | $p_{W3W4}$ = 0.0 | W1,W3,W4 | - |
